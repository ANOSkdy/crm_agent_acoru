  ...
  return (
    <div className="p-6 max-w-2xl">
      ...
      <form action={action} className="space-y-4 bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
        ...
        <label className="block text-sm font-medium">受注予定日<input name="expected_close_date" type="date" defaultValue={toDateInputValue(record.expected_close_date)} className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm" /></label>
