    ...
    <div className="p-6 max-w-2xl">
      ...
      <form action={action} className="space-y-4 bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
        ...
        <div>
          ...
          <input name="corporate_number" defaultValue={company.corporate_number ?? ''} pattern="[0-9]{13}" title="法人番号は13桁の数字で入力してください" className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        <div>
